...
import { useGetRevenueSummary, useGetCustomerRevenueReport } from "@workspace/api-client-react";
    ...
    <AppLayout>
      <div className="flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Month-over-Month Report</h1>
            <p className="text-muted-foreground mt-1">Compare revenue performance against the previous month.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-1">Previous Month</p>
                  {summaryLoading ? (
                    <Skeleton className="h-9 w-32" />
                  ) : (
